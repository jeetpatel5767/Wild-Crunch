...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full min-h-[70vh] lg:min-h-[40vh] bg-[#F8F7E5] overflow-hidden">
...
<ul className="space-y-2">
  ...
  <li><a href="/wishlist" className="text-[#466DDF] font-jost">WishList</a></li>
      ...
      <div className="relative z-10 flex flex-col lg:hidden px-6 py-8 min-h-[70vh]">
        {/* Heading */}
        <h2 className="text-center font-suez text-[#325DE8] text-3xl leading-snug mb-8 mt-12">
          Thank You For Your Curiosity.
        </h2>
        ...
        <div className="flex justify-between mr-8 ml-8">
          ...
          <div className="flex flex-col text-left">
            <h3 className="font-jost font-bold text-[#275AF3] text-lg mb-2">
              EXPLORE
            </h3>
            <ul className="space-y-2">
        ...
        {/* Copyright */}
        <div className="text-left text-[#466DDF] mt-4">
          <p className="text-sm font-jost">
            © {new Date().getFullYear()} WildCrunch - All Rights Reserved
          </p>
