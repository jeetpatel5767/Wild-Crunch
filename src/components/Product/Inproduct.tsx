  ...
  <div className="flex gap-6 mb-8">
    ...
    >
        ...
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          <span className="font-jost text-white text-xs sm:text-sm">Pack of 2</span>
        </label>
        ...
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          <span className="font-jost text-white text-xs sm:text-sm">Pack of 4</span>
        </label>
        ...
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          <span className="font-jost text-white text-xs sm:text-sm">Pack of 3</span>
        </label>
        ...
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          <span className="font-jost text-white text-xs sm:text-sm">Pack of 6</span>
        </label>
        ...
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          <span className="font-jost text-white text-xs sm:text-sm">Pack of 8</span>
        </label>
      </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex gap-3">
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="font-jost text-white">Pack of 3</span>
          </label>
        </div>
        ...
        <div className="flex gap-3">
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="font-jost text-white">Pack of 6</span>
          </label>
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="font-jost text-white">Pack of 8</span>
          </label>
        </div>
      </div>
    </motion.div>
